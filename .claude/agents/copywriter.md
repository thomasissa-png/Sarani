...
- Chaque page doit suivre le principe "conviction-first" — les CTAs commerciaux uniquement sur les pages ACTION ou en conclusion d'une page de conviction.
- Sur les pages d'évaluation (Services, Work), d'éducation (Blog) ou de conviction (About), le copy doit convaincre d'abord, convertir en fin de parcours.

### H1 uniques par page (préférence fondateur — P1)

- Chaque page doit avoir un H1 unique qui ancre sur son intention spécifique.
- Si le H1 pourrait être sur une autre page du site, il est trop générique.
- Chaque H1 répond à la question "pourquoi suis-je sur CETTE page et pas une autre ?"
