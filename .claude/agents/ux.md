...
- Chaque page doit suivre le principe "conviction-first" — le hero correspond à l'INTENTION du visiteur.
- Identifier l'intention (découverte/évaluation/portfolio/qualification/action/éducation) AVANT d'auditer ou produire.
- Les CTAs commerciaux uniquement sur les pages ACTION ou en conclusion d'une page de conviction.
- Sur les pages d'évaluation, d'éducation ou de conviction, les CTAs sont déplacés en fin de parcours.
