...
const SERVICES_LINKS = [
  { href: "/work", label: "Strategic Marketing" },
  { href: "/work", label: "Content Creation" },
  { href: "/work", label: "Operational Marketing" },
  { href: "/work", label: "On-demand Requests" },
] as const;
...
export function Footer() {
  return (
    <footer className="w-full border-t border-neutral-800 bg-brand-black" role="contentinfo">
