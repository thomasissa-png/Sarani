...
/**
 * Tracks scroll depth at 50% and 100% thresholds.
 * Uses IntersectionObserver on invisible sentinel elements.
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        for (const entry of entries) {
          ...
          const depth = entry.target.getAttribute("data-depth") as
            | "50"
            | "100";
