...
| 3g | AI Case Study Generator (auto-scan + auto-gen) | MULTI-AGENT PIPELINE COMPLETE — 3-step LLM (creative-strategy → copywriter → social), visual suggestions SharePoint, per-channel publish, dedicated /case-studies/[slug] page, LinkedIn buffer | @fullstack, @creative-strategy, @ia | Phase 3d |
